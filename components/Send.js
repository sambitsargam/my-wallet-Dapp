...
export default function Send() {
    ...
    return (
        <CustomContainer>
            <Text fontSize="xl" fontWeight="bold">Send MATIC</Text>
            <form onSubmit={async e => {
                ...
                fetch({
                    onSuccess: () => {
                        toast({
                            title: 'MATIC succesfully sent.',
                            description: "Fresh MATIC are showing up in receiver wallet.",
                            status: 'success',
                            duration: 9000,
                            isClosable: true,
                          })
                ...
                <Button mt="4" type="submit" colorScheme="blue" disabled={isFetching}>💸&nbsp; Send MATIC</Button>
            </form>
        </CustomContainer>
    )
}